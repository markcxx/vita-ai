...
const TEMPLATE_STYLES: Record<string, TemplateStyle> = {
  ...
  'folio-bookmark': { accent: '#cdd46d', headingStyle: 'plain' },
  'folio-spark': { accent: '#d3d956', headingStyle: 'plain' },
  'folio-breeze': { accent: '#87d5dc', headingStyle: 'plain' },
  'folio-diamond': { accent: '#df8589', headingStyle: 'bottom-border' },
  'folio-floral': { accent: '#8982da', headingStyle: 'plain' },
  'folio-gear': { accent: '#a19de6', headingStyle: 'plain' },
  'folio-banner': { accent: '#c9cb70', headingStyle: 'plain' },
  'folio-prism': { accent: '#9c96d8', headingStyle: 'left-border' },
  'folio-notebook': { headerBg: '#eb4c4f', accent: '#eb4c4f', headingStyle: 'left-border' },
  'folio-botanical': { accent: '#c8cc61', headingStyle: 'left-border' },
  'folio-line': { accent: '#cbd32e', headingStyle: 'bottom-border' },
  'folio-aqua': { accent: '#55cdd0', headingStyle: 'plain' },
