...
export function EditorSidebar({ sections, onAddSection, onReorderSections }: EditorSidebarProps) {
  ...
  return (
    <div data-tour="sidebar" className="relative flex h-full min-h-0 w-44 shrink-0 flex-col border-r border-border/60 bg-[#f6f6f7] dark:bg-[#191c22] max-md:w-full max-md:border-0">
      <div className="p-3">
