...
import { getIndustryInterviewers, INTERVIEWER_COLORS, DEFAULT_INTERVIEWER_COLOR } from '@/lib/interview/interviewers';
  ...
  return (
    <div className="rounded-lg border">
      ...
      >
        ...
        <Badge variant="secondary">{getIndustryInterviewers().find(person => person.type === evaluation.interviewerType)?.title || '自定义面试官'}</Badge>
