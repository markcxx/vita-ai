...
export function ExportButtons({ report, session }: ExportButtonsProps) {
  ...
  const exportMarkdown = () => {
    downloadFile(generateMarkdown(report, session, appName), `${filePrefix}.md`, 'text/markdown');
  };
...
function generateMarkdown(report: InterviewReport, session: InterviewSession, appName: string): string {
  const lines: string[] = [];
