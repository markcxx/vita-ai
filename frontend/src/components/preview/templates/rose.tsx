...
const PRIMARY = 'var(--resume-palette-881337, #881337)';
const ACCENT = 'var(--resume-palette-be185d, #be185d)';
const ROSE_50 = '#fff1f2';
const ROSE_100 = 'var(--resume-palette-ffe4e6, #ffe4e6)';
...
function RoseSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
