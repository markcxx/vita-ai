...
const PRIMARY = 'var(--resume-palette-1e3a5f, #1e3a5f)';
const ACCENT = 'var(--resume-palette-1d4ed8, #1d4ed8)';
const GRID = 'var(--resume-palette-dbeafe, #dbeafe)';
const BODY_TEXT = 'var(--resume-palette-374151, #374151)';
const MUTED = 'var(--resume-palette-6b7280, #6b7280)';
...
function ArchitectSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
