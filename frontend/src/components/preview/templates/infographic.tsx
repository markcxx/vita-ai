...
function InfographicSectionContent({ section, colorIndex, resume }: { section: TemplateResumeSection; colorIndex: number; resume: Resume }) {
  ...
  if (section.type === 'skills') {
    return (
      <div className="space-y-2">
        {(content.categories || []).map((cat, ci: number) => (
          <div key={cat.id}>
