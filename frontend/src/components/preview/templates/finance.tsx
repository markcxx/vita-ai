...
const SLATE_800 = 'var(--resume-palette-1e293b, #1e293b)';
const GOLD = 'var(--resume-palette-c4a747, #c4a747)';
...
function FinanceSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
