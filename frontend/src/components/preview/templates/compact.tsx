...
function CompactLeftContent({ section }: { section: TemplateResumeSection }) {
...
function CompactRightContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
  const content = section.content;
  if (!content) return null;
