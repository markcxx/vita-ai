...
const GRAY_700 = 'var(--resume-palette-374151, #374151)';
const BLUE_600 = 'var(--resume-palette-2563eb, #2563eb)';
...
function ConsultantSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
