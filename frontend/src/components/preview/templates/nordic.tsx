...
const SLATE_500 = 'var(--resume-palette-64748b, #64748b)';
const SLATE_400 = 'var(--resume-palette-94a3b8, #94a3b8)';
...
function NordicSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
