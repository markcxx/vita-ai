...
const PRIMARY = 'var(--resume-palette-1a472a, #1a472a)';
const ACCENT = 'var(--resume-palette-15803d, #15803d)';
const BORDER = 'var(--resume-palette-166534, #166534)';
...
function LegalSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
