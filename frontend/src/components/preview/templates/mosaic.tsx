...
const TILE_COLORS = ['var(--resume-palette-3b82f6, #3b82f6)', 'var(--resume-palette-10b981, #10b981)', 'var(--resume-palette-f59e0b, #f59e0b)', 'var(--resume-palette-8b5cf6, #8b5cf6)'];
...
function getTileBg(idx: number): string {
  const bgs = ['var(--resume-palette-eff6ff, #eff6ff)', 'var(--resume-palette-ecfdf5, #ecfdf5)', 'var(--resume-palette-fffbeb, #fffbeb)', '#f5f3ff'];
...
function MosaicSectionContent({ section, color, resume }: { section: TemplateResumeSection; color: string; resume: Resume }) {
