...
import type { Resume, PersonalInfoContent, SummaryContent, ProjectsContent, CertificationsContent, LanguagesContent, GitHubContent, CustomContent } from '@/types/resume';
import { degreeField, isSectionEmpty, md } from '../utils';
import { AvatarImage } from '../avatar-image';
import { QrCodesPreview } from '../qr-codes-preview';

const CHARCOAL = '#2d3436';
const EMERALD = 'var(--resume-palette-00b894, #00b894)';
...
function ExecutiveSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
