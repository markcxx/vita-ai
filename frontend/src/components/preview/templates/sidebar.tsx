...
const SIDEBAR_BG = 'var(--resume-palette-1e40af, #1e40af)';
...
function SidebarSectionContent({ section }: { section: TemplateResumeSection }) {
...
function MainSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
  const content = section.content;
  if (!content) return null;
