...
const TEAL_800 = 'var(--resume-palette-115e59, #115e59)';
const TEAL_500 = 'var(--resume-palette-0d9488, #0d9488)';
...
function MedicalSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
