...
const BLUE = 'var(--resume-palette-2563eb, #2563eb)';
const YELLOW = 'var(--resume-palette-eab308, #eab308)';
const RED_B = 'var(--resume-palette-dc2626, #dc2626)';
const TEXT = '#18181b';
...
function BerlinSectionContent({ section, lang }: { section: TemplateResumeSection; lang?: string }) {
