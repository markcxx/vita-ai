...
const BLUE = 'var(--resume-palette-0066cc, #0066cc)';
const TEAL = 'var(--resume-palette-0d9488, #0d9488)';
...
function CleanSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
