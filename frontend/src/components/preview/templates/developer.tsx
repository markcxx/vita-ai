...
const DARK = '#282c34';
const GREEN = 'var(--resume-palette-98c379, #98c379)';
const BLUE = 'var(--resume-palette-61afef, #61afef)';
const ORANGE = 'var(--resume-palette-e5c07b, #e5c07b)';
        ...
        {resume.sections
          ...
          .map((section) => (
            <div key={section.id} className="mb-6" data-section>
              ...
              <div className="border-l-2 pl-4" style={{ borderColor: 'var(--resume-palette-3e4451, #3e4451)' }}>
...
function DeveloperSectionContent({ section, resume }: { section: TemplateResumeSection; resume: Resume }) {
        ...
        {(content.items || []).map((item) => (
          <div key={item.id}>
            <div className="flex items-baseline justify-between">
              ...
              <span className="shrink-0 rounded px-2 py-0.5 text-[10px] font-medium" style={{ background: '#f0f0f0', color: 'var(--resume-palette-636d83, #636d83)' }}>
