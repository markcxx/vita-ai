  ...
  return (
    <div className="flex h-full flex-col p-2.5">
      <div className="mb-1.5 text-center">
        ...
        <div className="mx-auto mt-0.5 h-1 w-7 rounded-full bg-[#18181b]" />
      </div>
      <div className="h-1 w-8 rounded-full bg-[#475569]" />
      <div className="mt-1 flex-1 border-l-2 pl-2 ml-1" style={{ borderColor: '#e2e8f0' }}>
        <div className="relative mb-2">
          <div className="absolute -left-[13px] top-0.5 h-2 w-2 rounded-full border-2 bg-white" style={{ borderColor: '#18181b' }} />
          <div className="h-0.5 w-full rounded-full bg-zinc-200" />
          <div className="mt-0.5 h-0.5 w-3/4 rounded-full bg-zinc-200" />
        </div>
        <div className="relative mb-2">
  ...
  return (
    <div className="flex h-full flex-col p-2.5">
      ...
      <div className="space-y-1 flex-1">
        ...
        <div className="rounded-sm p-1" style={{ background: '#18181b' }}>
  ...
  return (
    <div className="flex h-full flex-col p-2">
      ...
      <div className="grid grid-cols-2 gap-0.5 flex-1">
        <div className="rounded p-0.5" style={{ background: '#f4f4f5' }}>
          <div className="h-0.5 w-full rounded-full" style={{ background: '#18181b' }} />
        </div>
