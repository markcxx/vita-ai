...
import { isReferenceTemplate, referenceTheme } from '../src/lib/reference-templates';
const MOCK_DATE = new Date('2025-01-01');
function buildMockResume(template: string, color?: string): Resume {
  return ({
    id: 'mock',
    userId: 'mock',
    title: '中文简历示例',
    ...
    sections: [
      {
        ...
        content: {
          fullName: '陈一鸣',
          avatar: '/images/templates/sample-cartoon-avatar-reference.png',
          jobTitle: '高级前端工程师',
